...
from inkypi.utils.app_utils import get_font
...
class Clock(BasePlugin):
    ...
    def generate_image(self, settings, device_config):
        ...
        primary_color = ImageColor.getcolor(
            settings.get("primaryColor") or (255, 255, 255), "RGB"
        )
        secondary_color = ImageColor.getcolor(
            settings.get("secondaryColor") or (0, 0, 0), "RGB"
        )
        ...
        try:
            ...
            logger.error(f"Failed to draw clock image: {e!s}")
