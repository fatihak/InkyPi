...
class Weather(BasePlugin):
    ...
    def generate_image(self, settings, device_config):
        ...
        template_params = self.parse_weather_data(
            weather_data, aqi_data, location_data, tz, units
        )
    ...
    def parse_data_points(self, weather, air_quality, tz, units):
        ...
        sunrise_dt = datetime.fromtimestamp(sunrise_epoch, tz=timezone.utc).astimezone(
            tz
        )
        data_points.append(
            {
                "label": self.translate("sunrise"),
        ...
        data_points.append(
            {
                "label": self.translate("visibility"),
        ...
        data_points.append(
            {
                "label": self.translate("air_quality"),
                "measurement": aqi,
                "unit": self.translate(f"aqi_levels.{aqi}"),
