...
class DateWidget(BaseWidget):
    def generate_settings_template(self):
        ...
        template_params['date_DMY'] = datetime.now().strftime('%d-%m-%Y')
        template_params['date_YMD'] = datetime.now().strftime('%Y-%m-%d')
        template_params['date_MDY'] = datetime.now().strftime('%m-%d-%Y')
    ...
    def generate_image(self, settings, device_config):
        ...
        strftime_format = format_map.get(date_format, '%Y-%m-%d')
        date_str = now.strftime(strftime_format)
